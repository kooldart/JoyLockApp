...
//    public PlaceJSONParser[] parse(JSONObject jObject){
//
...
//
//
//    private PlaceJSONParser[] getPlaces(JSONArray jPlaces){
//        int placesCount = jPlaces.length();
//        PlaceJSONParser[] places = new PlaceJSONParser[placesCount];
//
...
//    private PlaceJSONParser getPlace(JSONObject jPlace){
//
//        PlaceJSONParser place = new PlaceJSONParser();
//
//
//
//        try {
